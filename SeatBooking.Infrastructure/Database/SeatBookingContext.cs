...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Bookings__3214EC0780EE9589");
            ...
            entity.HasOne(d => d.Seat).WithMany(p => p.Bookings)
                ...
                .HasConstraintName("FK__Bookings__SeatId__3F466844");
        });

        modelBuilder.Entity<Seat>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Seats__3214EC07AC060403");
            ...
            entity.HasOne(d => d.ShowTime).WithMany(p => p.Seats)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Seats_ShowTime");
        });

        modelBuilder.Entity<SeatColor>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__SeatColo__3214EC0740FB2E7D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ShowTime__3214EC07D14D6ADE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC072793F14A");
            ...
            entity.HasOne(d => d.Bookings).WithMany(p => p.Transactions)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC0747DA56F0");
